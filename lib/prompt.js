...
function buildPrompt(rawEvent) {
  ...
  lines.push(
    ...
    "Any unused or empty placeholder — including extra lineup/DJ slots beyond the " +
      "names given (e.g. a 'DJ NAME 3' with no name) — must be removed COMPLETELY and " +
      "its area blended seamlessly into the surrounding background: no leftover text, " +
      "no empty gap, no box, no faint outline, no ghost trace. Only the actual values " +
      "listed above appear as text.",
