...
function buildPrompt(rawEvent) {
  ...
  const lines = [
    ...
    "For every text replacement: preserve the exact font style, weight, size, colour " +
      "and position of the original placeholder text. The replacement text must look " +
      "identical to the original placeholder in terms of typography, only the words " +
      "change. Do not introduce new fonts, do not change text colours, do not restyle " +
      "any text element.",
