...
function buildPrompt(rawEvent) {
  ...
  lines.push(
    "\nAny template placeholder text that has no matching user input must be removed " +
      "and left as clean background. Never keep visible placeholder words and never " +
      "invent replacement text. Render every letter exactly as written."
  );
