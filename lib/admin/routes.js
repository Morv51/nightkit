...
function register(router) {
  ...
  // ── Phase 3: Alle Datensaetze gebuendelt zu einem REGELWERK destillieren (ein Anthropic-
  //    Aufruf). Extrahiert nur WIEDERKEHRENDE Muster, getrennt in universelle + stilabhaengige
  //    Regeln, je Regel mit Belastbarkeit (beruht_auf). Ergebnis wird als getrennte Datei
  //    gespeichert (designRules), NICHT in den Bildprompt-Code geschrieben.
