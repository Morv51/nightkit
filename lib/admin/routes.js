...
function register(router) {
  ...
  // ── Phase 3: Alle Datensaetze zu einem REGELWERK destillieren — ZWEISTUFIG (je Stil-Kategorie
  //    ein Anthropic-Aufruf, danach einer ueber die Teil-Ergebnisse fuer die universellen
  //    Regeln), damit nie zu viel Text auf einmal entsteht. Extrahiert nur WIEDERKEHRENDE
  //    Muster, getrennt in universelle + stilabhaengige Regeln, je Regel mit Belastbarkeit
  //    (beruht_auf). Ergebnis wird als getrennte Datei gespeichert (designRules), NICHT in den
