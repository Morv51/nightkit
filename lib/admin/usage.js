...
const ACTIONS = [
  ...
  { key: "fal_outpaint",          label: "Reframe/9:16 (fal outpaint)",           provider: "fal" },
...
const DEFAULT_PRICES = {
  ...
  claude_analyze: 0.02, claude_variantspecs: 0.02, claude_variantprompts: 0.02,
  claude_tag: 0.003, claude_caption: 0.003,
  fal_outpaint: 0.05, replicate_remove: 0.01,
};
