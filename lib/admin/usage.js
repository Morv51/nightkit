...
const ACTIONS = [
  ...
  { key: "claude_promptgen_analysis", label: "Prompt-Generator Analyse (Claude)",  provider: "Anthropic" },
  { key: "claude_promptgen_convert",  label: "Prompt-Generator Konvertierung (Claude)", provider: "Anthropic" },
...
const DEFAULT_PRICES = {
  ...
  claude_promptgen_analysis: 0.09, claude_promptgen_convert: 0.035,
