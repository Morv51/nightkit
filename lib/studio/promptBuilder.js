...
function buildMoodboardPrompt(dna, opts = {}) {
  ...
  const lines = [
    ...
    ...(isVariant ? [
      ...
      "A reference flyer from this style family is provided alongside this prompt (and may also appear " +
        ...
        "typography treatment, illustration / rendering style, texture, restraint and overall composition " +
        "logic. This is a VARIATION of that flyer.",
  ...
  if (ov.length) {
    ...
    lines.push("VARIATION — keep the STYLE ANCHOR identical (same mood, typography character, texture, " +
      ...
      ". Still ONE big subject + text around it + lots of negative space — no grid, no collage.");
  }
