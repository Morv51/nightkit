...
function buildPlaceholderPrompt(zones, opts = {}) {
  ...
  return [
    ...
    "",
    // (5/5) LAYOUT — in der Variante folgt die Platzierung der neuen Anordnung; das Verbot des
    //       platten Stapels und der Motiv-Schutz bleiben (Typo-Qualitaet).
    ...(isVariant ? [
      "LAYOUT — art-directed for this variation:",
      v(vr.layout)
      ...
      "- HEADLINE / SUBLINE dominant; DATE / TIME / LOCATION as a designed core-info block; DJ NAME 1-3 " +
        ...
        "PLACEMENT follows the new arrangement, not a fixed top-to-bottom order.",
