...
const PATH = "/v1/nano-banana-pro";
const TIMEOUT_MS = 180 * 1000; // Nano Banana Pro kann lange dauern
...
function generate({ apiKey, prompt, imageUrls = [], aspectRatio = "9:16", safetyTolerance = 6, outputFormat = "png" }) {
  return new Promise((resolve, reject) => {
    ...
    console.log(`[studio-segmind] → POST https://${HOST}${PATH} | refs=${imageUrls.length} aspect=${aspectRatio} safety=${safetyTolerance} promptLen=${prompt.length}`);
