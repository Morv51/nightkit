        ...
        if (state.cleanFlow) {
          if (state.variants > 0) {
            try {
              ...
              // Artwork hat einen EIGENEN Sonnet-Aufruf (komplette Regie). Der Rohtext aus
              // cleanArtworks wird bewusst VERWORFEN — er gehoert nicht in den Lauf-Zustand,
              // der nach R2 persistiert wird; nur die Vorschau zeigt ihn.
              file.variantPrompts = state.cleanArtwork
