...
const LEITIDEE_KEYS = "leitidee, fuellgrad, blickfang, rangfolge, lautstaerke, ";
const LEITIDEE_SPEC =
  ...
  "reason. Read leitidee, fuellgrad, blickfang, rangfolge and lautstaerke FAITHFULLY from THIS reference — " +
  "NEVER a default: a restrained reference must give restrained values, a loud one loud values. ";
