...

{
  ...
  "headline_style": "the character of the headline typeface, max 12 words",
  "headline_material": "the hard material from the picture the headline letters are cut from, e.g. the marble of the columns. Empty only if none is visible, max 12 words",
  "secondary_style": "character of the secondary typeface with concrete letterform traits, never just the category, max 12 words",
  "place_headline": "position, max 12 words",
  ...
  "colour_field": "optional, only if the picture has no usable ground: a field with straight edges anchored in one corner. Empty means none, max 12 words"
}
...
const REDESIGN_FIELDS = ["staging", "headline_style", "headline_material", "secondary_style",
  "place_headline", "place_date", "place_lineup", "place_club",
  "treatment", "ornament", "carriers", "colour_field"];
