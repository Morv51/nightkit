...
const MOODBOARD_SYSTEM =
  ...
  "ORIGINAL club event flyer can be created in the same spirit. Describe only " +
  "abstract visual style for reinterpretation — never transcribe or describe any " +
  "TEXT CONTENT, names, dates or logos in the reference. Reply with STRICT JSON " +
  "only (no markdown, no commentary) using exactly these keys: look_mood, " +
  "color_world, imagery, typography, composition, visual_hierarchy, " +
  "texture_grain_light, editorial_club_look. Each value is one concise English " +
  "phrase usable directly inside an image-generation prompt.";
...
const FLYER_SYSTEM =
  ...
  "image, and the single most likely ROLE from EXACTLY this set: " + ROLES + ". " +
  "Use OTHER for text that is none of these (taglines, prices, fine print). Order " +
