...
async function analyzeDesignPatterns({ imageBase64, mediaType, model }) {
  return visionCall({
    ...
    imageBase64, mediaType, model, maxTokens: 2500,
  });
}
...
module.exports = { isConfigured, analyzeMoodboard, analyzeReference, generateVariationSpecs, variantPrompts, analyzeFlyer, tagFlyer, analyzeDesignPatterns, MODELS };
