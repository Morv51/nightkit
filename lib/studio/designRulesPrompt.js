...
// Handpfad, aus der geprueften Zuordnung). vorrang: "leitidee" (Default, bisheriges
// Verhalten) | "original" (Handpfad).
...
function selectRuleLines(ruleset, opts = {}) {
  ...
  // und ueber ihnen steht, was der Aufrufer als vorrangig gesetzt hat (Leitidee bzw. Original).
  lines.push("DESIGN RULES — craft guidance distilled by a graphic designer from " + (basis || "many") +
    ...
    "technical blocks below — they never cancel or weaken any of them. " + vorrang + " The rule texts are in German:");
