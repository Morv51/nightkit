...
// Typografie + grafische Traeger: steht bewusst in EINEM Absatz zusammen. Der zweite Satz der
// Traeger-Ergaenzung ("only where it gives a group a home") ist nicht verhandelbar — ohne ihn
// klebt das Modell jedem Template wahllos Sticker/Tape auf. "drawn from the artwork's own world"
// haelt die Elemente stilkonform. Gilt fuer BEIDE Modi (Nachbau und Variante).
const P_TYPO =
  ...
  "never a flat even list. Give the information physical form: let text groups sit on small graphic devices " +
  "drawn from the artwork's own world — tape, torn paper, tags, badges, rules, numbering, markers. Not " +
  "decoration for its own sake, only where it gives a group a home.";
