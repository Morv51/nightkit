...
const ARTWORK_3 =
  "One bold move carries the poster: the headline is huge and runs in a single line, and the subject cuts " +
  "across it so parts of the letters sit behind the image. Depth, not overlay. Dense in one area, close to " +
  "empty in another. The smaller texts follow the same craft: clear size hierarchy between the groups, never a " +
  "flat even list. Headline horizontal.";
const ARTWORK_5 =
  "Printed matter, not a clean digital render: paper grain, print texture, slight misregistration.";
...
function buildCleanArtworkPrompt(spec) {
  ...
  const colour = cw ? "Colour world: " + cw + ". One decisive gesture in this colour, never decoration." : "";
