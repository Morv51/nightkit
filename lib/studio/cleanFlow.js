...
// Typografie + grafische Traeger: steht bewusst in EINEM Absatz zusammen. Gilt fuer BEIDE Modi.
// Traeger-Satz bewusst SPARSAM formuliert (frueher wirkte die Sechser-Aufzaehlung als Checkliste
// und das Modell nutzte alle gleichzeitig -> ueberladen). "drawn from the artwork's own world"
// haelt die Elemente stilkonform. Headline gerade (kein schraeger/rotierter Titel).
const P_TYPO =
  ...
  "never a flat even list. Keep the headline straight and horizontal, never tilted or rotated. Where it helps, " +
  "let a text group sit on a small graphic device drawn from the artwork's own world, e.g. a strip of tape, a " +
  "tag or a rule. Use this sparingly, for one or two groups at most, never for every group.";
...
const P_LITERAL =
  ...
  "venue, or the DJ slots into real names. The placeholders are the ONLY text on the flyer. Do not add any " +
  "other words, labels or captions, not even on graphic devices.";
...
// Varianten-Bildprompt: Nachbau-Geruest, nur der KEEP-Kern ersetzt. spec: { color_world, subject }.
